...
const TampoInferiorModal = ({ visible, onClose, onSave, initialData }) => {
    ...
    >
      <View style={styles.modalBackground}>
        <View style={styles.modalContainer}>
          ...
          <Text style={styles.title}>Tampo Inferior</Text>
          ...
          <Pressable style={styles.registerTampoInferior} onPress={handleSave}>
            <Text style={styles.registerTampoInferiorText}>Registrar Tampo Inferior</Text>
...
export default TampoInferiorModal;
