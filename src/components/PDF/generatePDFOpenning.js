...
const generatePDFOpenning = async (selectedProject) => {
  ...
  try {
    ...
    const tableDataAnotherExample = [
      ["N° SÉRIE", "N° RELATÓRIO", "IDENTIFICADOR EQUIPAMENTO"],
      [
    ...
    let columnWidthsAnotherExample = [147.64, 147.64, 200];
    ...
    const tableDataEquipmentNextInspections = [
      ["EXTERNA", "INTERNA"],
      [
        `${selectedProject.inspection.DateNextInspectionPLHExternal}`,
        `${selectedProject.inspection.DateNextIsnpectionPLHInternal}`
      ]
    ];
...
export default generatePDFOpenning;